...
enum class MsgType: unsigned int {
    ...
    CT_DOCKER_SYNC_APP_CFG_RES = 18,
    CT_PORTAL_LIST_APP_CFG_RES = 19,
    CT_PORTAL_UPDATE_APP_CFG_RES = 20,

    // docker agent
    DA_DOCKER_HEARTBEAT_REQ = 3000,
    DA_DOCKER_RUNTIME_INFO_SYNC_REQ = 3001,
    DA_DOCKER_SAY_HI = 3002,
    DA_DOCKER_SYNC_APP_CFG_REQ = 3003,
    ...
    PO_PORTAL_LIST_APP_CFG_REQ = 9009,
    PO_PORTAL_UPDATE_APP_CFG_REQ = 9010,
