...
find_library(LIBRESTCLIENT_CPP_LIBRARIE restclient-cpp
             HINTS ${PC_RESTCLIENT_CPP_LIBDIR} ${PC_RESTCLIENT_CPP_LIBRARY_DIRS})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(
        Restclient-cpp DEFAULT_MSG
        LIBRESTCLIENT_CPP_INCLUDE_DIR LIBRESTCLIENT_CPP_LIBRARIE)
mark_as_advanced(LIBRESTCLIENT_CPP_INCLUDE_DIR LIBRESTCLIENT_CPP_LIBRARIE)

set(LIBRESTCLIENT_CPP_INCLUDE_DIRS ${LIBRESTCLIENT_CPP_INCLUDE_DIR})
set(LIBRESTCLIENT_CPP_LIBRARIES ${LIBRESTCLIENT_CPP_LIBRARIE})